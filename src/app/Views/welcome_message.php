...
<head>
    ...
    <meta name="description" content="El framework ligero con características potentes">
...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="https://codeigniter.com/user_guide/" target="_blank">Documentación</a>
            </li>
            <li class="menu-item hidden"><a href="https://forum.codeigniter.com/" target="_blank">Comunidad</a></li>
            <li class="menu-item hidden"><a
                    href="https://codeigniter.com/contribute" target="_blank">Contribuye</a>
            </li>
        </ul>
    </div>
    ...
    <div class="heroe">
        ...
        <h1>Bienvenido a CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?> Docker</h1>

        <h2>El framework ligero con características potentes y completamente dockerizado</h2> 
...
<section>
    ...
    <p>Esta página está siendo generada dinámicamente por CodeIgniter en un entorno Docker, lo que ofrece las siguientes ventajas:</p>

    <ul style="margin-bottom: 20px;">
        <li>Entorno de desarrollo consistente y reproducible</li>
        <li>Fácil despliegue y escalabilidad</li>
        <li>Aislamiento de dependencias</li>
        <li>Configuración estandarizada del entorno</li>
        <li>Portabilidad entre diferentes sistemas operativos</li>
    </ul>

    <p>Si deseas modificar esta página, la encontrarás en:</p>
...
<div class="further">
    ...
    <section>
        ...
        <p>La Guía del Usuario contiene una introducción, tutorial, varias guías prácticas
            y documentación de referencia para los componentes que conforman el framework.
            ¡Consulta la <a href="https://codeigniter.com/user_guide/"
            target="_blank">Guía del Usuario</a>!</p>
        ...
        <p>CodeIgniter es un proyecto de código abierto desarrollado por la comunidad,
            con varios espacios donde los miembros pueden reunirse e intercambiar ideas.
            Visita todos los hilos en el <a href="https://forum.codeigniter.com/"
            target="_blank">foro de CodeIgniter</a>, o <a href="https://join.slack.com/t/codeigniterchat/shared_invite/zt-rl30zw00-obL1Hr1q1ATvkzVkFp8S0Q"
            target="_blank">chatea en Slack</a>!</p>
        ...
        <p>CodeIgniter es un proyecto impulsado por la comunidad y acepta contribuciones
            de código y documentación. ¿Por qué no
            <a href="https://codeigniter.com/contribute" target="_blank">
            te unes a nosotros</a>?</p>
...
<footer>
    ...
    <div class="copyrights">
        ...
        <p>&copy; <?= date('Y') ?> CodeIgniter Foundation. CodeIgniter es un proyecto de código abierto publicado bajo la
            licencia MIT.</p>
