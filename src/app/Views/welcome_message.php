        ...
        <ul>
            <li class="logo">
                <a href="https://codeigniter.com" target="_blank">
                    <svg role="img" aria-label="Visita el sitio web oficial de CodeIgniter!"
...
<section>
    ...
    <p>Esta página está siendo generada dinámicamente por CodeIgniter en un entorno Docker, lo que ofrece las siguientes
        ventajas:</p>
    ...
    <section>
        ...
        <p>CodeIgniter es un proyecto de código abierto desarrollado por la comunidad,
            ...
            Visita todos los hilos en el <a href="https://forum.codeigniter.com/"
                                            target="_blank">foro de CodeIgniter</a>, o <a
...
<footer>
    ...
    <div class="copyrights">
        ...
        <p>&copy; <?= date('Y') ?> CodeIgniter Foundation. CodeIgniter es un proyecto de código abierto publicado bajo
            la
            licencia MIT.</p>
